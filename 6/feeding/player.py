...
from .feeding_intent import FeedNone, StoreFat, FeedVegetarian, FeedCarnivore
...
class Player:
    ...
    def feed_fat_tissue(self):
        ...
        if len(species_with_fat_tissue) > 0:
            ...
            return StoreFat(self.species.index(eater), eater.body - eater.fat_food)
