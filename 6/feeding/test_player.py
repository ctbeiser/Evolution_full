...
from .feeding_intent import FeedNone, FeedVegetarian, StoreFat, FeedCarnivore
...
class PlayerTestCase(TestCase):
    ...
    def test_next_species_to_feed_none(self):
        ...
        # no species to feed
        player = Player(1)
        self.assertIsInstance(player.next_species_to_feed([]), FeedNone)
    ...
    def test_next_species_to_feed_fat_tissue(self):
        ...
        # no species to feed
        player.species = []
        self.assertIsNone(player.feed_fat_tissue())
        ...
        feeding = player.feed_fat_tissue()
    ...
    def test_next_species_to_feed_carnivore(self):
        ...
        for enemies, attacker, enemy, defender in test_cases:
            ...
            result = player.next_species_to_feed(enemies)
